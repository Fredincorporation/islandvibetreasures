...
export function CategoryPage({
  ...
  return (
    <div className="min-h-screen">
      {/* Category hero */}
      <div className={`py-12 sm:py-16 px-4 ${heroColor}`}>
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-white/80 mt-2 max-w-lg mx-auto text-base sm:text-lg"
          >
            {subtitle}
          </motion.p>
          <motion.p
            ...
            className="text-white/60 text-xs font-semibold uppercase tracking-widest mt-2"
          >
            {filteredProducts.length} Treasures Available
          </motion.p>
        </div>
      </div>
      ...
      {subcategories.length > 1 && (
        <div className="bg-white border-b border-sand-200 sticky top-16 z-30 shadow-xs">
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedSubcategory === sub
                    ...
                    : "bg-sand-50 border-sand-200 text-sand-700 hover:bg-sand-100 hover:border-sand-300"
                )}
              >
                {sub === "all" ? "All Items" : sub.replace("-", " ")}
              </button>
            ))}
          </div>
        </div>
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white rounded-2xl border border-sand-200 p-12 text-center my-4">
                ...
                <p className="text-sand-600 max-w-sm mx-auto mb-6">
                  We couldn't find any products matching your selected criteria in {title.toLowerCase()}.
                </p>
                <button
                  onClick={clearFilters}
